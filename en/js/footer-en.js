...
footer += '<div class="ctn footer-div">';
    footer += '<div class="footer-menu">';
        footer += '<ul>';
            footer += '<li><a href="bad_tv.html">Bathroom TV</li>';
        ...
        footer += '<ul>';
            footer += '<li><a href="spiegel_tv.html">Mirror TV</li>';
        ...
        footer += '<ul>';
            footer += '<li><a href="kuechen_tv.html">Kitchen TV</li>';
        ...
        footer += '<ul>';
            footer += '<li><a href="kuechen_smart.html">Kitchen Smart</li>';
        ...
        footer += '<ul>';
            footer += '<li><a href="rahmen_tv.html">Frame TV</li>';
 ...
 footer += '<a id="buy" href="https://www.mues-tec.de/shop/en/" target="_blank">BUY</a>';
